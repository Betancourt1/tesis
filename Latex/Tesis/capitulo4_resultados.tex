\chapter{Resultados}
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Bandas de Incertidumbre de Resultados}
            ...
            La Tabla~\ref{tab:rangos_consolidados_p3_p4} sintetiza mínimos, máximos y amplitudes y muestra qué métricas permanecen estables y cuáles varían materialmente según supuestos e intervenciones; esta lectura habilita decidir qué indicadores requieren monitoreo prioritario.
            ...
            La Figura~\ref{fig:rangos_intervenciones_punto4} compara visualmente los rangos por escenario y permite evaluar si la amplitud de las bandas altera o confirma la priorización entre intervenciones, habilitando sustentar decisiones aun bajo incertidumbre estructural.
