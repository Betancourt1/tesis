\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
        ...
        \subsubsection{Centralidad de Cercanía (Closeness Centrality)}
            ...
            \begin{itemize}
                \item \textbf{Hallazgos Clave:} Los nodos con mayor centralidad de cercanía se concentran de manera casi exclusiva en el \textbf{hipercentro de la ciudad}. Esto confirma que, en términos de tiempo de viaje, el centro es el punto más accesible de la red y aquel desde el cual el tiempo promedio para alcanzar otros destinos es menor. A diferencia de otras medidas, la brecha entre los primeros lugares es relativamente moderada.
            \end{itemize}
