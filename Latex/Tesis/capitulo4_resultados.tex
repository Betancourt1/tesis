\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
        ...
        \subsubsection{Centralidad de Eigenvector (Eigenvector Centrality)}
            ...
            \begin{figure}[h!]
                ...
                \caption{Grafo con centralidades: más grande es mayor grado de eigenvector y más verde significa mayor centralidad de cercanía.}
	...
	\subsection{Conclusiones sobre el $L$-espacio}
	    Con el análisis realizado podemos concluir algunas cosas interesantes de la infraestructura que da forma al sistema de transporte público en la Zona Metropolitana de Guadalajara. En primer lugar, tiene una estructura arbórea que nos indica que está en gran medida enfocada en conectar zonas periféricas con otras más centralizadas. En segundo lugar, aunque el hipercentro concentra gran parte de la intermediación, también aparecen nodos de intersección relevantes fuera del centro, como estaciones del tren ligero o cruces comerciales estratégicos. Con todo esto, es una red altamente resiliente a la desaparición de nodos críticos y su eficiencia espacial es casi óptima, lo que nos indica que tiene una distribución espacial muy favorable en la zona de cobertura. 
    ...
    \section{Análisis del P-espacio: La Red de Servicio}
        ...
        \subsection{Métricas globales del P-espacio}
            ...
            \begin{itemize}
                ...
                \item \textbf{Eficiencia y caminos:} Diámetro topológico \textbf{6} saltos y longitud promedio de camino \textbf{2.41} saltos (equivalentes a \textbf{hasta 5} y \textbf{1.41} trasbordos, respectivamente, bajo la convención aristas$-1$), con eficiencia global \textbf{0.4476} en el componente principal.
            \end{itemize}
        ...
        \subsection{Análisis de Centralidad en el P-espacio}
            ...
            \end{figure}
                ...
                \caption{Grafo con centralidades: más grande es mayor grado y más verde significa mayor centralidad de cercanía.}
        ...
        \subsection{Análisis de Robustez del P-espacio}
            Se aplicó el mismo esquema de ataque dirigido al P-espacio: eliminación secuencial de los \textbf{50 supernodos (nodos) con mayor grado}. Tras cada eliminación se midieron el tamaño relativo del LCC y la eficiencia global no dirigida.

            \begin{figure}[h!]
                \centering
                \includegraphics[width=\textwidth]{../../grafos/p_space/robustez/grafico_robustez_p_space_comparativo.png}
                \caption{Impacto en el LCC y la Eficiencia Global del P-espacio al eliminar los 50 supernodos de mayor grado.}
        ...
        \subsection{Sensibilidad de Supuestos de Modelado}
            ...
            \begin{table}[h!]
                \centering
                \caption{Sensibilidad del \(L\)-espacio ante el umbral de consolidación espacial.}
            ...
            \begin{table}[h!]
                \centering
                \caption{Diferencia estructural en \(P\)-espacio: clique por ruta vs. clique por viaje.}
                \label{tab:sensibilidad_p_space_route_trip}
                \begin{tabular}{lrrrr}
                    \toprule
                    Umbral (m) & Aristas route\_id & Aristas trip\_id & Route-only & Route-only (\%) \\
                    \midrule
        ...
        \subsection{Escenarios de Intervención Topológica}
            ...
            \end{itemize}
            En todos los casos se midió el impacto tras remover 50 nodos por grado ponderado usando: porcentaje de \(LCC\), eficiencia global dirigida (ponderada por \texttt{travel\_time\_minutes}) y diámetro topológico del componente gigante.

            \begin{table}[h!]
                \centering
                \caption{Comparativo de escenarios de intervención topológica en \(L\)-espacio (post-ataque dirigido de 50 nodos).}
            ...
            Los resultados muestran que no todas las intervenciones mejoran de la misma forma:
            \begin{itemize}
                \item \textbf{Protección de hubs} mejora la conectividad residual del sistema (\(+0.79\) pp en \(LCC\) post frente al base), aunque no reduce el diámetro.
                \item \textbf{Refuerzo periférico} es el escenario con mejor desempeño global en eficiencia bajo ataque (retención de \(88.52\%\) vs \(82.50\%\) base) y reduce el diámetro de 84 a 53.
                \item \textbf{Recableado con bypass} mejora ligeramente la conectividad (\(+0.31\) pp en \(LCC\)), pero pierde eficiencia relativa, por lo que requiere optimización adicional antes de considerarse una recomendación operativa.
            \end{itemize}
            En conjunto, la evidencia sugiere priorizar estrategias de \textbf{refuerzo periférico} y \textbf{protección de hubs} como primeras líneas de intervención cuantificable para incrementar resiliencia sin depender exclusivamente del hipercentro.
        ...
        \subsection{Bandas de Incertidumbre de Resultados}
            ...
            \begin{table}[h!]
                \centering
                \small
                \caption{Rangos consolidados de métricas principales (puntos 3 y 4).}
                ...
                \begin{tabular}{llrrr}
                    ...
                    P3 (modelado) & Route-only en P-space (\%) & 8.73 & 20.86 & 12.13 \\
            ...
            Los rangos muestran que la \textbf{conectividad global} de la red física es estable frente a los supuestos de consolidación (\(LCC\) de \(99.81\%\) a \(99.88\%\)); en cambio, la magnitud de \textbf{sobrerepresentación potencial} en \(P\)-espacio (aristas route-only) cambia de manera importante (\(8.73\%\) a \(20.86\%\)). Bajo ataque dirigido, las intervenciones producen diferencias operativas relevantes: la retención de eficiencia varía entre \(79.68\%\) y \(88.52\%\), y el diámetro post-ataque entre 53 y 97 saltos.
            ...
            \begin{figure}[h!]
                ...
                \caption{Bandas min--max por escenario de intervención topológica en \(L\)-espacio (punto 4).}
