\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
        ...
        \subsubsection{Impacto en la Eficiencia Global}
            La eficiencia global cae al \textbf{81.50\%} de su valor original tras la eliminación de esos 50 nodos. Aunque la red sigue conectada, los caminos disponibles son menos directos y se pierde cerca del 18.50\% de la eficiencia relativa, lo que evidencia la dependencia operativa de los supernodos de mayor grado.
    ...
    \section{Análisis del P-espacio: La Red de Servicio}
        ...
        \subsection{Métricas globales del P-espacio}
            ...
            \begin{itemize}
                ...
                \item \textbf{Eficiencia y caminos:} Diámetro por saltos \textbf{6} y longitud promedio de camino \textbf{2.41} saltos (equivalentes a \textbf{hasta 5} y \textbf{1.41} transbordos, respectivamente, bajo la convención \textit{transbordos = saltos - 1}), con eficiencia global \textbf{0.4476} en el componente principal.
            \end{itemize}
	    La densidad, casi dos órdenes de magnitud mayor que en el L-espacio, indica que la representación \(P\) contiene muchas conexiones potenciales entre supernodos que comparten ruta. El clustering elevado refleja cliques de paradas por rutas compartidas; por ello, esta densidad debe leerse como redundancia estructural del modelo de servicio, no como garantía directa de capacidad operativa real.
            ...
            Además, un diámetro de 6 saltos y una longitud promedio de camino de 2.41 muestran que cualquier supernodo está a pocos pasos de otro. En conjunto, estos valores son consistentes con la literatura que describe este tipo de redes como sistemas de \textit{mundo pequeño}.
        ...
        \subsection{Análisis de Centralidad en el P-espacio}
            ...
            Los indicadores de centralidad recalculables directamente desde el grafo ubican el máximo de centralidad en el hipercentro (coordenadas aproximadas $20.668^{\circ}$ N, $-103.348^{\circ}$ O). Destacan:
            \begin{itemize}
                \item \textbf{Supernodo 264} (7 paradas). Encabeza las métricas verificables de grado, cercanía y eigenvector en el recálculo directo sobre el grafo \(P\). Concentra 30 rutas, entre ellas C05, C06, C111-V1/V3 y C118, y funciona como nodo natural de transferencia en el centro.
                \item \textbf{Supernodo 262} (15 paradas) y \textbf{698} (5 paradas). También pertenecen al clúster central; el primero reúne 27 rutas y el segundo 25 rutas, y ambos aparecen en los primeros lugares de grado y cercanía.
        ...
        \subsection{Detección de Comunidades en el P-espacio}
            Se detectaron \textbf{11 comunidades} de supernodos mediante Louvain, agrupando paradas que comparten muchas rutas (modularidad $0.537$). Las cinco mayores concentran el 66.9\% de los supernodos del servicio:
            \begin{itemize}
                \item \textbf{Comunidad 5} (\textasciitilde\!17.4\%): centroide $(20.5729,-103.3589)$, domina el sur-poniente.
                \item \textbf{Comunidad 1} (\textasciitilde\!15.2\%): centroide $(20.6888,-103.2990)$, eje nororiente.
                \item \textbf{Comunidad 2} (\textasciitilde\!12.3\%): centroide $(20.6285,-103.3056)$, oriente-centro.
                \item \textbf{Comunidad 8} (\textasciitilde\!11.7\%): centroide $(20.7403,-103.3937)$, norponiente.
                \item \textbf{Comunidad 6} (\textasciitilde\!10.3\%): centroide $(20.6573,-103.2995)$, corredor central-oriente.
            \end{itemize}
            El resto incluye clusters poniente (Comunidad 4, 9) y núcleos menores (comunidades 0, 3, 7), mientras que sólo una comunidad es pequeña (\(\leq 5\) nodos), reflejando alta conectividad transversal del servicio.
        ...
        \subsection{Análisis de Robustez del P-espacio}
            Se aplicó el mismo esquema comparativo al P-espacio. En el ataque dirigido se eliminaron secuencialmente los \textbf{50 supernodos con mayor grado}; en los fallos aleatorios se removieron 50 supernodos siguiendo varias permutaciones aleatorias reproducibles. Tras cada eliminación se midieron el tamaño relativo del LCC y la eficiencia global no dirigida. En las curvas aleatorias, debido a la alta densidad del \(P\)-espacio, la eficiencia se estimó mediante muestreo de 128 fuentes por iteración; se usaron 30 repeticiones aleatorias con semilla base 42.
            ...
            \begin{itemize}
                ...
                \item Bajo fallos aleatorios, el LCC medio después de 50 remociones es \textbf{98.81\%} y la eficiencia media retenida es \textbf{99.67\%}. Las bandas empíricas 5--95\% son estrechas para el LCC (\textbf{98.79\%}--\textbf{98.81\%}) y moderadas para eficiencia (\textbf{97.51\%}--\textbf{102.17\%}).
            \end{itemize}
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Escenarios de Intervención en la Red Modelada}
            ...
            \begin{itemize}
                ...
                \item \textbf{Refuerzo periférico:} se toma el componente débil principal, se ignora la dirección de las aristas para calcular cercanía con distancias de camino y se ordenan los supernodos de menor a mayor cercanía. De la periferia así definida se forman pares entre extremos opuestos de la lista, descartando pares ya adyacentes o separados por menos de cuatro saltos. Para cada par aceptado se agregan dos aristas dirigidas, una por sentido, con peso temporal igual a la mediana global de tiempos válidos y \texttt{original\_edge\_count}=1. Con los parámetros usados se agregan 60 pares, es decir, 120 aristas dirigidas.
            ...
            La Tabla~\ref{tab:intervenciones_estructurales_l_space} compara las métricas postataque para cada escenario y permite distinguir qué intervención conserva mejor el LCC y la eficiencia sin alargar en exceso los recorridos tras la falla.
            ...
            \begin{table}[h!]
                ...
                \label{tab:intervenciones_estructurales_l_space}
                \resizebox{\textwidth}{!}{%
                \begin{tabular}{lrrrrr}
                    \toprule
