\chapter{Resultados}
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Escenarios de Intervención Topológica}
            ...
            \begin{itemize}
                \item \textbf{Protección de nodos críticos:} se protegen los 10 supernodos de mayor grado ponderado y se aplica el mismo ataque dirigido de 50 nodos sobre el resto.
                ...
                \item \textbf{Conexiones alternativas locales:} se agregan hasta 200 aristas directas entre predecesores y sucesores de supernodos de alto grado, con el fin de crear rutas alternativas que eviten pasar por esos nodos críticos.
            \end{itemize}
            En los cuatro escenarios se aplicó el mismo ataque dirigido: eliminación secuencial de los 50 supernodos con mayor grado ponderado. Después del ataque se midieron tres indicadores: el porcentaje de nodos remanentes que permanece en el componente gigante, la eficiencia global dirigida (ponderada por \texttt{travel\_time\_minutes}) y el diámetro topológico de ese componente.
            ...
            \begin{table}[h!]
                \centering
                \small
                \caption{Comparación de intervenciones topológicas en \(L\)-espacio después de eliminar 50 supernodos de mayor grado ponderado. Se reportan las aristas añadidas, el porcentaje de nodos remanentes que permanece en el componente gigante, la eficiencia conservada y el diámetro resultante.}
                \label{tab:intervenciones_topologicas_l_space}
                \resizebox{\textwidth}{!}{%
                \begin{tabular}{lrrrrr}
                    \toprule
                    Escenario & Aristas añadidas & Componente gigante (\%) & Eficiencia conservada (\%) & Diámetro resultante & Cambio vs.\ base (pp) \\
                    \midrule
                    Base (sin intervención) & 0   & 98.51 & 82.50 & 84 & 0.00 \\
                    Protección de nodos críticos & 0   & 99.30 & 85.58 & 97 & +0.79 \\
            ...
            \begin{itemize}
                \item \textbf{Protección de nodos críticos} es la mejor opción para preservar conectividad: eleva el porcentaje del componente gigante de \(98.51\%\) a \(99.30\%\). Sin embargo, esa mejora viene acompañada de un diámetro mayor (de 84 a 97), es decir, la red residual queda más unida pero más alargada.
                \item \textbf{Refuerzo periférico} ofrece el mejor balance operativo: mantiene el componente gigante al nivel del escenario base, pero logra la mayor eficiencia conservada (\(88.52\%\) frente a \(82.50\%\)) y reduce el diámetro de 84 a 53. En términos prácticos, conserva recorridos más cortos después del ataque.
                \item \textbf{Conexiones alternativas locales} sólo aporta una mejora marginal en conectividad (\(+0.31\) puntos porcentuales en el componente gigante), pero reduce la eficiencia relativa a \(79.68\%\), por debajo del escenario base. En su forma actual, no justifica su costo estructural y requeriría una regla de diseño más afinada.
            \end{itemize}
            En conjunto, la evidencia sugiere priorizar \textbf{refuerzo periférico} cuando el objetivo principal es sostener tiempos de recorrido razonables bajo falla, y \textbf{protección de nodos críticos} cuando se busca maximizar la conectividad residual. Ambas estrategias resultan más defendibles que las conexiones alternativas locales y, además, reducen la dependencia exclusiva del hipercentro.

            Aplicado al transporte público real, esto no significa que deban añadirse literalmente 120 aristas o protegerse exactamente 10 nodos, sino que conviene traducir esas intervenciones topológicas en decisiones de planeación y operación. El \textbf{refuerzo periférico} apunta a fortalecer conexiones transversales fuera del centro mediante servicios tangenciales, extensiones de ruta, enlaces entre corredores, mejor coordinación de frecuencias o prioridad semafórica en trayectos que hoy obligan a pasar por el hipercentro. La \textbf{protección de nodos críticos}, por su parte, sugiere concentrar medidas de resiliencia en terminales, estaciones de transferencia y corredores cuya falla fragmenta más la red: reserva de flota, regulación operativa, carriles preferentes, mantenimiento prioritario y planes de contingencia.

            En cambio, el bajo desempeño de las \textbf{conexiones alternativas locales} indica que no basta con añadir enlaces por cercanía topológica. En un sistema de transporte público, una conexión nueva sólo es útil si también es operable, tiene demanda razonable y no introduce desvíos que alarguen recorridos o consuman flota de forma ineficiente. Por ello, esta subsección debe leerse como una guía de priorización estructural, no como un diseño final de rutas o infraestructura.
