\chapter{Resultados}
    ...
    \section{Análisis del P-espacio: La Red de Servicio}
        ...
        \subsection{Métricas globales del P-espacio}
            ...
            \end{itemize}
	    La densidad, casi dos órdenes de magnitud mayor que en el L-espacio, indica que la red de servicio ofrece muchas alternativas de conexión directa entre supernodos que comparten ruta. El clustering elevado refleja cliques de paradas por rutas compartidas, es decir, una redundancia operativa considerable.
        ...
        \subsection{Análisis de Centralidad en el P-espacio}
            ...
            \end{itemize}
            En conjunto, la centralidad revela una red de servicio fuertemente articulada alrededor del centro histórico y de varios corredores troncales, con una redundancia de rutas que ayuda a sostener la cercanía y la conectividad del sistema.
        ...
        \subsection{Análisis de Robustez del P-espacio}
            ...
            \begin{itemize}
                ...
                \item La eficiencia global desciende a \textbf{97.36\%}, una caída moderada que sugiere que existen suficientes rutas alternativas para conservar recorridos relativamente cortos aun cuando fallan los supernodos principales.
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Discusión Comparativa}
            El ataque dirigido por grado es significativamente más dañino en el L-espacio que en el P-espacio. Mientras que en la infraestructura física la eficiencia cae cerca de 18.50\% al perder 50 supernodos de mayor grado, en la red de servicio la pérdida es de apenas 2.64\%. Esta comparación usa la misma métrica de eficiencia relativa al estado inicial en ambos grafos y se complementa con las simulaciones aleatorias como línea base de perturbaciones no dirigidas.
