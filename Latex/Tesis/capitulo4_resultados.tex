\chapter{Resultados}
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Escenarios de Intervención en la Red Modelada}
            ...
            La pregunta de decisión es directa: ¿qué intervención conserva mejor la cobertura conectada del sistema y, al mismo tiempo, evita que los recorridos se vuelvan mucho más largos tras la falla? La Tabla~\ref{tab:intervenciones_topologicas_l_space} responde al comparar las métricas post-ataque para cada escenario.
            ...
            El mensaje central de esta subsección no es que deban añadirse literalmente 120 conexiones o protegerse exactamente 10 puntos, sino que la resiliencia del sistema mejora más cuando se refuerzan alternativas útiles de viaje y se asegura la continuidad operativa de los puntos de intercambio más sensibles. Un peor recorrido interno más alto no describe una distancia física mayor, sino que, en el modelo, algunos trayectos pasan a requerir encadenar más segmentos consecutivos; por tanto, representa una red que bajo falla obliga a itinerarios más largos, más indirectos o más frágiles. Por ello, esta subsección debe leerse como una guía de priorización para la planeación y la operación del transporte público, no como un diseño final de rutas o infraestructura.
