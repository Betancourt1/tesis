\chapter{Resultados}
    ...
    \section{Análisis del P-espacio: La Red de Servicio}
        ...
        \subsection{Escenarios de Intervención Topológica}
            ...
            \end{itemize}
            En todos los casos se midió el impacto tras remover 50 nodos por grado ponderado usando: \(LCC\) post sobre nodos remanentes, eficiencia global dirigida (ponderada por \texttt{travel\_time\_minutes}) y diámetro topológico del componente gigante.
            ...
            \begin{itemize}
                \item \textbf{Protección de hubs} mejora la conectividad residual del sistema (\(+0.79\) pp en \(LCC\) post frente a la base), pero incrementa el diámetro post-ataque de 84 a 97.
                ...
                \item \textbf{Recableado con bypass} mejora ligeramente la conectividad (\(+0.31\) pp en \(LCC\)), pero pierde eficiencia relativa frente a la base, por lo que requiere optimización adicional antes de considerarse una recomendación operativa.
            \end{itemize}
