...
\section{Análisis del L-espacio: La Red de Infraestructura}
    ...
    Después de eliminar los 50 nodos de mayor grado, el LCC conserva el \textbf{97.45\%} de sus nodos (ver \texttt{grafos/l_space/robustez/robustez\_ataque\_grado.csv}). Esto indica que la red física mantiene la mayoría de su conectividad, aunque se generan pequeñas pérdidas de cobertura periférica.
...
\section{Análisis del P-espacio: La Red de Servicio}
    ...
    Se detectaron \textbf{11 comunidades} de rutas mediante Louvain, agrupando líneas que comparten muchas paradas. El atributo \texttt{community} en el archivo GEXF permite visualizarlas en Gephi.
