\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
        ...
        \subsubsection{Impacto en la Conectividad (LCC)}
            ...
            % TODO [PDF p.64][abel][resaltado: "LCC"]: revisar si la sigla debe ir en texto normal y no en itálicas matemáticas.
            % TODO [PDF p.64][abel][resaltado: "98,51 %"]: revisar consistencia de punto decimal en porcentajes y cifras numéricas.
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Sensibilidad de Supuestos de Modelado}
            ...
            % TODO [PDF p.70][abel][resaltado: "LCC"]: unificar la consistencia tipográfica de LCC, porque aparece con formatos distintos.
        ...
        \subsection{Escenarios de Intervención en la Red Modelada}
            ...
            \begin{itemize}
                % TODO [PDF p.71][abel][resaltado: "98,51 % a 99,30 %."]: revisar puntos decimales en todos los porcentajes del capítulo.
