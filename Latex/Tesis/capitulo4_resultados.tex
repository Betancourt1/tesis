\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
		...
		\item \textbf{Densidad del Grafo:} La densidad es de \textbf{0.000486}, un valor coherente con una red de contigüidad física. En este grafo, cada supernodo se conecta principalmente con las paradas consecutivas de las rutas que lo atraviesan, de modo que el número de aristas posibles es reducido.
                \item \textbf{Conectividad:} El análisis de componentes conectados arrojó un resultado clave: la red está fragmentada en \textbf{2 componentes}. Uno de ellos es masivo, conteniendo 4,198 nodos (el 99.80\% del total), mientras que el segundo es un fragmento aislado de apenas 5 nodos. Esto sugiere que, en la práctica, la red funciona casi como un todo unificado, pero existe una pequeña \textit{isla} de paradas sin conexión con el resto del sistema.
        ...
        \subsubsection{Accesibilidad y Cobertura de la Red (Matriz de Shimbel)}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item \textbf{15 minutos:} Se alcanza solo el 6.50\% de la red.
                    \item \textbf{30 minutos:} Se alcanza el 33.10\% de la red.
                    \item \textbf{45 minutos:} Se alcanza el 61.90\% de la red.
                    \item \textbf{60 minutos:} Se alcanza el 80.10\% de la red.
                \end{itemize}
        ...
        \subsubsection{Metodología de la Simulación}
            ...
            \end{itemize}
            El número de nodos a eliminar se fijó en 50 para tener una condición de parada clara y concentrarse en el impacto de los supernodos de mayor grado.

        \subsubsection{Resultados del Análisis de Robustez}
            La Figura~\ref{fig:robustez_l_space} resume cómo se deterioran el LCC y la eficiencia temporal cuando fallan supernodos de alto grado bajo el mismo ataque dirigido.
    ...
    \section{Análisis del P-espacio: La Red de Servicio}
        ...
        \subsection{Detección de Comunidades en el P-espacio}
            ...
            \begin{itemize}
                \item \textbf{Comunidad 5} (\textasciitilde\!18.20\%): centroide $(20.5748,-103.3608)$, domina el sur-poniente.
                \item \textbf{Comunidad 1} (\textasciitilde\!15.20\%): centroide $(20.6887,-103.2992)$, eje nororiente.
                \item \textbf{Comunidad 8} (\textasciitilde\!11.70\%): centroide $(20.7404,-103.3939)$, norponiente.
                \item \textbf{Comunidad 2} (\textasciitilde\!11.50\%): centroide $(20.6293,-103.2990)$, oriente-centro.
                \item \textbf{Comunidad 6} (\textasciitilde\!10.30\%): centroide $(20.6573,-103.2995)$, corredor central-oriente.
            \end{itemize}
        ...
        \subsection{Análisis de Robustez del P-espacio}
            ...
            La Figura~\ref{fig:robustez_p_space} muestra la pérdida de cobertura y eficiencia cuando fallan los supernodos de mayor grado bajo el ataque dirigido.
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Discusión Comparativa}
            El ataque dirigido por grado es significativamente más dañino en el L-espacio que en el P-espacio. Mientras que en la infraestructura física la eficiencia cae cerca de 18.50\% al perder 50 supernodos de mayor grado, en la red de servicio la pérdida es de apenas 2.64\%. Esta comparación usa la misma métrica de eficiencia relativa al estado inicial en ambos grafos.
        ...
        \subsection{Sensibilidad de Supuestos de Modelado}
            ...
            En el \(L\)-espacio, al variar el umbral de consolidación cambia de forma importante el tamaño de la red, pero no su conectividad global: en todos los escenarios el componente gigante concentra más del 99.80\% de los supernodos y no se observaron aristas con tiempo imputado.
