\chapter{Resultados}
    ...
    \section{Análisis del L-espacio: La Red de Infraestructura}
        ...
        \subsubsection{Resultados del Análisis de Robustez}
            % TODO [PDF p.64][abel]: revisar si la sigla LCC debe ir en redonda/texto y no en itálicas matemáticas.
        ...
        \subsubsection{Impacto en la Conectividad (LCC)}
            % TODO [PDF p.64][abel]: unificar el uso de punto decimal en porcentajes y cifras numéricas.
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Sensibilidad de Supuestos de Modelado}
            ...
            % TODO [PDF p.70][abel]: revisar la consistencia tipográfica de LCC, porque en distintas partes aparece con formatos distintos.
            ...
            % TODO [PDF p.71][abel]: revisar los puntos decimales en todos los porcentajes del capítulo para mantener un criterio único.
