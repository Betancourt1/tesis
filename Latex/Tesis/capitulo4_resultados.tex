\chapter{Resultados}
    ...
    \section{Síntesis comparativa y validación del modelo}
        ...
        \subsection{Escenarios de Intervención en la Red Modelada}
            ...
            \begin{itemize}
                \item \textbf{Protección de puntos críticos del sistema:} se asume continuidad reforzada en los 10 supernodos que más articulan la red modelada. En términos operativos, esto representa terminales, estaciones de transferencia o corredores cuya interrupción compromete buena parte de la cobertura restante.
                \item \textbf{Refuerzo periférico:} se añaden 120 conexiones dirigidas al modelo para representar servicios tangenciales o enlaces entre corredores fuera del hipercentro, con el fin de reducir la dependencia de pasos obligados por el centro.
                \item \textbf{Conexiones alternativas locales:} se añaden hasta 200 conexiones directas en el modelo para representar rodeos de corto alcance alrededor de puntos muy cargados, de modo que ciertos desplazamientos no dependan de pasar por un mismo punto de transferencia.
            \end{itemize}
            En los cuatro escenarios se aplicó la misma perturbación severa: eliminación secuencial de los 50 supernodos de mayor grado ponderado. Después de la falla se midieron tres indicadores: el porcentaje de supernodos remanentes que permanece dentro del LCC, la eficiencia global dirigida (ponderada por \texttt{travel\_time\_minutes}) y la longitud del peor recorrido interno, definida como el número máximo de segmentos consecutivos necesarios dentro de la red remanente.
