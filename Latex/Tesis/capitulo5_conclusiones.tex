...
% TODO [PDF p.76][abel]: hay un resaltado sin texto asociado en la apertura de conclusiones; revisar manualmente la marca original del PDF para decidir qué frase debía corregirse.
% TODO [PDF p.76][abel]: hay un segundo resaltado sin texto asociado en esta misma zona; requiere verificación manual directa en el PDF.
% TODO [PDF p.79][abel]: comentario general, la parte teórica fue percibida como cargada con conceptos que no se usan y eso dificulta el seguimiento; revisar posible depuración.
% TODO [PDF p.79][abel]: en espíritu de transparencia y reproducibilidad, considerar publicar archivos o tablas con los valores de los grafos del capítulo 4.
% TODO [PDF p.79][abel, citando a Fernando Becerra]: desarrollar más el uso de datos GTFS y formalizar mejor la validación de la tesis central.
...
% TODO [PDF p.77][abel]: comentario positivo, "me gusta esta tabla"; no exige cambio, pero conviene preservarla en revisiones posteriores.
