...
\begin{table}[h!]
    ...
    \begin{tabular}{p{0.17\textwidth} p{0.22\textwidth} p{0.20\textwidth} p{0.20\textwidth} p{0.17\textwidth}}
        ...
        Ataque dirigido (50 nodos/supernodos de mayor grado). L-espacio: LCC $97.45\%$, eficiencia $81.5\%$ ($\sim 19\%$ de caída). P-espacio: LCC $98.74\%$, eficiencia $97.36\%$ ($\sim 2.6\%$ de caída). &
