...
\begin{enumerate}
    % TODO [PDF p.76][abel][resaltado: "0,1088" en la versión revisada del PDF]: no hay comentario escrito; revisar formato decimal del coeficiente de clustering.
    % TODO [PDF p.76][abel][resaltado: "(~18.50%)" en la versión revisada del PDF]: no hay comentario escrito; revisar consistencia de notación para la caída porcentual.
...
% TODO [PDF p.77][abel][nota flotante sobre: "Tabla de trazabilidad entre preguntas, métricas, resultados, implicaciones y límites"]: conservar esta tabla; el comentario dice "me gusta esta tabla".
\begin{table}[h!]
    \centering
    \scriptsize
...
\begin{enumerate}
    ...
    % TODO [PDF p.79][abel][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: revisar comentario general; la parte teórica contiene conceptos que no se usan y puede confundir, aunque quizá sea más costoso quitarlos que mantenerlos.
    % TODO [PDF p.79][abel][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: por transparencia y reproducibilidad, considerar publicar archivos o tablas con los valores correspondientes a los grafos del capítulo 4.
    % TODO [PDF p.79][abel, citando a Fernando Becerra][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: desarrollar más el uso de datos GTFS y formalizar mejor la validación de la tesis central.
\end{enumerate}
