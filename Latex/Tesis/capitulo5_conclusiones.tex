...
% TODO [PDF p.77][abel][cat: conservar][prio: baja][nota flotante sobre: "Tabla de trazabilidad entre preguntas, métricas, resultados, implicaciones y límites"]: conservar esta tabla; el comentario dice "me gusta esta tabla".
\begin{table}[h!]
    \centering
    \scriptsize
    ...
    \begin{tabular}{@{}p{0.15\textwidth} p{0.20\textwidth} p{0.18\textwidth} p{0.18\textwidth} p{0.15\textwidth}@{}}
        ...
        Ataque dirigido (50 supernodos de mayor grado). L-espacio: LCC $97.45\%$, eficiencia $81.50\%$ (caída de aproximadamente \(18.50\%\)). P-espacio: LCC $98.74\%$, eficiencia $97.36\%$ (caída de aproximadamente \(2.64\%\)). &
...
\begin{enumerate}
    ...
    % TODO [PDF p.79][abel][cat: estructura][prio: alta][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: revisar comentario general; la parte teórica contiene conceptos que no se usan y puede confundir, aunque quizá sea más costoso quitarlos que mantenerlos.
    % TODO [PDF p.79][abel][cat: reproducibilidad][prio: alta][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: por transparencia y reproducibilidad, considerar publicar archivos o tablas con los valores correspondientes a los grafos del capítulo 4.
    % TODO [PDF p.79][abel, citando a Fernando Becerra][cat: metodologia][prio: alta][nota flotante al pie de página bajo: "Dependencia de datos: recálculo programado de comunidades..."]: desarrollar más el uso de datos GTFS y formalizar mejor la validación de la tesis central.
\end{enumerate}
