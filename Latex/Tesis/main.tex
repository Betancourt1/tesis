...
\chapter{Marco Teórico}
	\section{Fundamentos de la teoría de grafos}
		...
		\subsection{Algoritmos fundamentales en teoría de grafos}
			...
			El algoritmo de Floyd-Warshall encuentra el camino más corto entre todos los pares de nodos en un grafo ponderado con pesos arbitrarios (incluyendo negativos, pero sin ciclos negativos). Se basa en la programación dinámica y mejora iterativamente una matriz de distancias.
