...
- Citar todas las fuentes utilizadas (formato APA o requerido por tu institución).

\chapter{Apéndices}
- Tablas, gráficos o análisis complementarios.
- Código utilizado en el análisis.

\chapter{Anexos}
- Documentos o datos relevantes adicionales.
