...
\chapter{Marco Teórico}
	\section{Fundamentos de la teoría de grafos}
		...
		\subsection{Definición y conceptos básicos}
			...
			\subsubsection{Ejemplo de un grafo no dirigido}
			...
			\subsubsection{Ejemplo de un grafo dirigido}
			...
			\subsubsection{Ejemplo de un grafo ponderado}
