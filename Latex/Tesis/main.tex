...
% Establecemos globalmente el estilo de flechas
...
\chapter{Marco Teórico}
	\section{Fundamentos de la teoría de grafos}
		...
		\subsection{Definición y conceptos básicos}
			...
			\subsection{Ejemplo de un grafo no dirigido}
			...
			\subsection{Ejemplo de un grafo dirigido}
			...
			\subsection{Ejemplo de un grafo ponderado}
