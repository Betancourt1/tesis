...
% TODO [PDF p.82][abel][nota flotante sobre: "tabla de archivos GTFS: agency.csv, stops.csv, routes.csv..."]: mencionar estos archivos solo es útil si están disponibles en algún repositorio o anexo accesible.
\begin{table}[H]
    \centering
