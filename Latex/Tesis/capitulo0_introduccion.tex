...
% TODO [PDF p.9][Fernando Becerra]: revisar si la alineación/justificación del texto introductorio debe ajustarse en la maquetación final.
...
% TODO [PDF p.9][Fernando Becerra]: revisar si la tesis central necesita referencias explícitas o anclaje bibliográfico adicional.
% TODO [PDF p.9][Fernando Becerra]: precisar qué significa exactamente "relativamente robusto" y cuál es la definición operativa de robustez en este contexto.
...
% TODO [PDF p.9][ernes]: formular una o dos preguntas de investigación explícitas, por ejemplo sobre robustez ante fallos dirigidos y nodos críticos cuya eliminación fragmente la red.
