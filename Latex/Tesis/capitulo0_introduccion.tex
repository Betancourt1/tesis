...
% TODO [PDF p.9][Fernando Becerra][cat: formato][nota flotante sobre: "El transporte público es la columna vertebral..."]: revisar el comentario "No se si debe ir justificada la alineación del texto" para la maquetación final.
...
% TODO [PDF p.9][Fernando Becerra][cat: referencias][resaltado: "enfoques previos"]: agregar o revisar referencias para sustentar esa comparación con trabajos previos.
...
% TODO [PDF p.9][Fernando Becerra][cat: metodologia][resaltado: "relativamente robusto"]: definir operativamente qué significa "robusto" y qué es "relativo" en este contexto.
...
% TODO [PDF p.9][ernes][cat: metodologia][resaltado: "Planteamiento del Problema"]: formular una o dos preguntas explícitas de investigación, por ejemplo sobre robustez ante fallos dirigidos y nodos críticos cuya eliminación fragmenta la red.
